...
<p>You can find the project dependencies in the <a href="[LICENSE](https://github.com/TheRadDani/Image-Captioning/blob/main/requirements.txt)">requirements.txt</a> file.</p>
